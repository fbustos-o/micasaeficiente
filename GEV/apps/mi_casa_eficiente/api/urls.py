...
from .api import consulta_comunas, datos_demanda, edita_consumo, datos_equipos, edita_equipos, recomendaciones, recomendaciones_priorizadas
...
urlpatterns = [
    ...
    path('recomendaciones/<int:pk>', recomendaciones, name = 'Recomendaciones'), #Paso 4: recomendaciones y selección de prioridades
